...
def add_food(request):
  ...
  if request.method == 'POST':
    ...
    Food.objects.create(agency=agency, ftime=ftime, fname=fname, fprice=fprice, description=description, fimage=fimage, ftype=ftype, roti=roti, veg=veg, rice=rice, butter_milk=butter_milk, papad=papad)
...
def update_food(request, id):
  ...
  Food.objects.update_or_create(pk=id,  defaults={ 'ftime':ftime, 'fname':fname, 'fprice':fprice, 'description':description, 'fimage':fimage, 'ftype':ftype, 'roti':roti, 'veg':veg, 'rice':rice, 'butter_milk':butter_milk, 'papad':papad})
